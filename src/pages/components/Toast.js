			...
			<Content page="component">
				<BlockHead size="lg" wide="sm">
					<BlockHeadContent>
						...
						<BlockDes>
							<p className="lead">
								Push notifications to your visitors with a toast, a lightweight and easily customizable alert message. It's built with
								flexbox, so they’re easy to align and position. To use it, import it such as{" "}
