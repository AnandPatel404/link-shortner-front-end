...
import { DropdownMenu, DropdownToggle, UncontrolledDropdown, Modal, ModalBody, FormGroup, Progress, DropdownItem, Form } from "reactstrap";
import { useForm } from "react-hook-form";
import useqrCode from "../../../zustand/qrCode/qrCode";

const ProjectCardPage = () => {
	const { useqrCodes, allQr } = useqrCode((state) => ({
		useqrCodes: state.getAllQr,
		allQr: state.allQr,
	}));
		...
		<React.Fragment>
			...
			<Content>
				<BlockHead size="sm">
					<BlockBetween>
						<BlockHeadContent>
							<BlockDes className="text-soft">Your Qr</BlockDes>
						</BlockHeadContent>
						<BlockHeadContent>
				...
				<Block>
					...
					{/* <div className="mt-3">
						<PaginationComponent itemPerPage={itemPerPage} totalItems={data.length} paginate={paginate} currentPage={currentPage} />
					</div> */}
				</Block>
