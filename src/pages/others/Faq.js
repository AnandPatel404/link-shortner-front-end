...
import { Accordian, Block, BlockContent, BlockDes, BlockHead, BlockHeadContent, BlockTitle, PreviewCard } from "../../components/Component";
								...
								<BlockContent>
									<div className="nk-block-content-head px-lg-4">
										...
										<p className="text-soft">
											Ask a question or file a support ticket, manage request, report an issues. Our support team will get back
											to you by email.
										</p>
									</div>
								</BlockContent>
								<BlockContent className="flex-shrink-0">
									<Link to={`${process.env.PUBLIC_URL}/contact-us`} className=" btn btn-outline-primary btn-dim">
										Get Support Now
									</Link>
								</BlockContent>
							</div>
